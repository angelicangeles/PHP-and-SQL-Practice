...
$AddItemValue = htmlspecialchars($_REQUEST["AddItemValue"]);
$condition = "";
$ItemName="";
if ($AddItemValue == "1") {
    ...
    <body class="w3-light-grey">
        ...
        <div class="w3-main" style="margin-left:300px;margin-top:43px;">
            ...
            <header class="w3-container" style="padding-top:22px">
                <h5><b><i class="fa fa-bullseye fa-fw"></i> Add Item</b></h5>
            </header>
            <center>
                <form method="POST" action="AddItemPROCESS.php">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="white-box">
                                <h3 class="box-title">Inventory - Add Item</h3><br><br>
                                <div class="form-group">

                                    <div class="col-md-4">
                                        <input type='text' class="form-control" class="form-control form-control-line" placeholder='Item Name' name='ItemName' value="<?php echo $ItemName; ?>"title='ItemName' <?php echo $condition; ?>>
                                    </div><br>
                                    <div class="col-md-2">
                                        <input type="number" name="ItemQuantity" placeholder="Item Quantity" class="form-control form-control-line">
                                    </div>
                                    <br>
                                    <div class="col-sm-2">
                                        <input type="submit" value="Add Item" class="w3-button w3-dark-grey"/>
                                    </div>
                                </div>
                            </div>
                        </div>
