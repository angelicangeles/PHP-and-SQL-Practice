    ...
    <body class="w3-light-grey">
        ...
        <nav class="w3-sidebar w3-collapse w3-white w3-animate-left" style="z-index:3;width:300px;" id="mySidebar"><br>
            ...
            <div class="w3-bar-block">
                ...
                <?php if ($class->checkIfMasterAdmin($_SESSION["AdminUsername"], $_SESSION["AdminPassword"]) == TRUE) { ?>
                    <a href="RegisterAdmin.php" class="w3-bar-item w3-button w3-padding w3-blue"><i class="fa fa-eye fa-fw"></i>  Register Admin</a>
                <?php } ?>
        ...
        <div class="w3-main" style="margin-left:300px;margin-top:43px;">
            ...
            <header class="w3-container" style="padding-top:22px">
                <h5><b><i class="fa fa-eye fa-fw"></i> Register Admin</b></h5><br>
            </header>
            <center>
                <form action="SignUpPROCESS.php" method="post" >
                    <input type="hidden" name="HiddenValue" value="1" required>
                    <input type="text" name="FirstName" placeholder="First Name" required>
                    <input type="text" name="MiddleName" placeholder="Middle Name" required>
                    <input type="text" name="LastName" placeholder="Last Name" required>
                    <input type="text" name="Suffix" placeholder="Suffix">
                    <input type="text" name="ContactNo" placeholder="Contact Number" required><br><br>
                    <input type="number" name="HouseNo" placeholder="House Number" required>
                    ...
                    <br>
                    <input type="date" placeholder="Birth Date" name="Birthday" value="yyyy-MM-dd" required><br><br>
                    <br>
                    <input type="text" name="Barangay" placeholder="Barangay" required>
                    <input type="text" name="City" placeholder="City" required>
                    <input type="text" name="Region" placeholder="Region" required>
                    
                    <input type="text" name="SSS" placeholder="SSS Reference No" required>
                    <br><br>
                    <input type="text" name="PagIbig" placeholder="Pag Ibig Reference No" required>
                   
                    <input type="text" name="BirthCertificate" placeholder="NSO Birth Certicate Reference No" required>
                   
                    <input type="text" name="GSIS" placeholder="GSIS Reference No">
                   
                    <input type="text" name="PhilHealth" placeholder="PhilHealth Reference No" required>
                    <br><br>
