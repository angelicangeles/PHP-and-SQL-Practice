...
<nav class="w3-sidebar w3-collapse w3-white w3-animate-left" style="z-index:3;width:300px;" id="mySidebar"><br>
  ...
  <div class="w3-bar-block">
    ...
    <a href="dashboard.php" class="w3-bar-item w3-button w3-padding w3-blue"><i class="fa fa-bell fa-fw"></i>  Dashboard</a>
  ...
  <div class="w3-container">
    ...
    <div class="w3-row">
      <div class="w3-col m2 text-center">
          <img class="w3-circle" src="img/user3.png" style="width:96px;height:96px">
      </div>
