...
$result = $class->getAdminTransactionLog();
?>
<html>
    ...
    <body class="w3-light-grey">
        ...
        <nav class="w3-sidebar w3-collapse w3-white w3-animate-left" style="z-index:3;width:300px;" id="mySidebar"><br>
            ...
            <div class="w3-bar-block">
                ...
                <a href="AdminTransactionLogs.php" class="w3-bar-item w3-button w3-padding w3-blue"><i class="fa fa-history fa-fw"></i>  Admin Transaction Logs</a>
        ...
        <div class="w3-main" style="margin-left:300px;margin-top:43px;">
            ...
            <header class="w3-container" style="padding-top:22px">
                <h5><b><i class="fa fa-history fa-fw"></i> Admin Transaction Logs</b></h5>
            </header>
            <div class="row">
                <div class="col-12">
                    <section>
